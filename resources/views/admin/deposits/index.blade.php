...
@section('title', 'Pengajuan Simpanan Berjangka')
                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $key => $data)
                                <tr>
                                    ...
                                    <td>{{ 'Rp' . number_format($data->current_balance, 0, ',', '.') }}</td>
                                    <td>{{ $data->product_type }}</td>
                                    <td
                                        class="text-center text-bold @if ($data->status == 0) text-warning @elseif ($data->status == 2) text-danger @else text-success @endif">
                                        @if ($data->status == 0)
                                            <div class="row">
                                                <div class="col-6">
                                                    <button id="{{ $data->id }}"
